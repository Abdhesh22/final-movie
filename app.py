...
#making the login/register feature 
mongo = PyMongo(app, uri ="mongodb+srv://abd03:abd1847@cluster0.lupbw.mongodb.net/movie?retryWrites=true&w=majority")
...
def index():
    ...
    try:
        ...
        return render_template('index.html',username=username,movie_name = names, poster_path = posters,movie = movie,overview = overview,links=links,genre = genre)
